...
public class MainTest {
    ...
    public void makeMain(String inputText) {
        ...
        main = new RocMain(input, output, error);
    }

    @Test
    public void run_help()
        throws RocMain.Exception, FileNotFoundException, IOException {
    ...
    public void run_version()
        ...
        main.run(cmd);
        // Informational output goes to regular output
        assertEquals(MetaInfo.NAME + " " + MetaInfo.VERSION_STRING + System.lineSeparator(), outputString.toString());
        assertEquals("", errorString.toString());
    }
