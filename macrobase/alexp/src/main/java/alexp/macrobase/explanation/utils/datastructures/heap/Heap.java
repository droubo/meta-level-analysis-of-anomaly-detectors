...
import alexp.macrobase.explanation.utils.datastructures.iterator.Iter;
 ...
 * 
 * @param <E> Element type. Should be {@link Comparable} or a
 *        {@link Comparator} needs to be given.
 */
public class Heap<E> {
  /**
   * heap storage.
   ...
   * @author Erich Schubert
   */
  public class UnorderedIter implements Iter {
    /**
