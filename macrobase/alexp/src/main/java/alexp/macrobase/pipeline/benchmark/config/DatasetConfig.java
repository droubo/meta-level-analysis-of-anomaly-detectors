...
public class DatasetConfig {
    ...
    private final String subspaceColumn;

    public DatasetConfig(String datasetId, Uri uri, String[] metricColumns, String labelColumn, String subspaceColumn) {
        this.datasetId = datasetId;
        this.uri = uri;
        this.metricColumns = metricColumns;
        this.labelColumn = labelColumn;
        this.subspaceColumn = subspaceColumn;
    }
    ...
    public static DatasetConfig load(StringObjectMap conf) {
        ...
        String subspaceColumn = "subspaces";

        return new DatasetConfig(id, uri, metricColumns, labelColumn, subspaceColumn);
    }
    ...
    public String getSubspaceColumn() {
        return subspaceColumn;
    }
}
