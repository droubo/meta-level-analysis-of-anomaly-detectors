        ...
        for(MCO d : dataList){
            ...
            for(MCO n: dataList){
                if(d != n){
                    ...
                    if(isNeighbor(n,d)) d.neigh_count += 1;
                }
            }
            double[] nearest_center_info = findNearestCenter(d);
            d.minDistance = nearest_center_info[1];
            
            d.criterion = (1/((double)d.neigh_count + 1.0)) * d.minDistance;
            //System.out.print(d.minDistance);
            //System.out.print(" - ");
            //System.out.print(1/((double)d.neigh_count + 1.0));
            //System.out.print(" - ");
           // System.out.print(d.criterion);
            //System.out.println("==");
...
//        mtree.add(o);
    ...
    private double[] findNearestCenter(MCO d) {
        ...
        double [] ret = {min_center_id, min_distance};
        return ret;
    }
...
//                    addToHashMap(inPD.arrivalTime(),d.arrivalTime());
    ...
    private void process_event_queue(int currentTime) {
        ...
        while (x != null && x.ev <= currentTime) {
            ...
            x.criterion = x.exps.size() + x.numberOfSucceeding + 1;
