 ...
 * Builder} accepts collections of objects and the {@link
 * PrimitivesBuilder} accepts arrays of primitive numbers.  (You
 * can use the class {@link alexp.macrobase.evaluation.roc.util.IterableArray} to treat
