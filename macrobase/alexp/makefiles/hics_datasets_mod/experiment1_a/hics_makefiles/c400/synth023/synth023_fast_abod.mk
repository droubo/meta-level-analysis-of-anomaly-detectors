...
all:
	tmux new -d -s mod_hics_data_exp1a_hics_c400_23_fast_abod
	tmux send-keys -t mod_hics_data_exp1a_hics_c400_23_fast_abod.0 "cd ~/Documents/macrobase" ENTER
	tmux send-keys -t mod_hics_data_exp1a_hics_c400_23_fast_abod.0 $(BENCH_COMMAND) ENTER
