...
public class RandomProjectionTest {
    ...
    @Test
    public void testRandomProjection() throws Exception {
        int k = 5;
        MacroBaseConf conf = new MacroBaseConf().set(MacroBaseConf.RANDOM_PROJECTION_K, k);
        double[][] test_input = {
        ...
        RandomProjection rp = new RandomProjection(conf);
        rp.consume(data);
