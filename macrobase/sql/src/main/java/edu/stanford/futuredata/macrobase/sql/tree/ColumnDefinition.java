...
public final class ColumnDefinition extends Node {
    ...
    public ColumnDefinition(NodeLocation location, Identifier name, String type,
        Optional<String> comment) {
        this(Optional.of(location), name, type, comment);
    }

    private ColumnDefinition(Optional<NodeLocation> location, Identifier name, String type,
        Optional<String> comment) {
        super(location);
