...
public class BinnedKDETest {
    ...
    public void simpleTest() throws ConfigurationException {
        MacroBaseConf conf = new MacroBaseConf()
                .set(KDE.KDE_KERNEL_TYPE, "EPANECHNIKOV_MULTIPLICATIVE")
                .set(KDE.KDE_BANDWIDTH_ALGORITHM, "OVERSMOOTHED")
                .set(BinnedKDE.BINNED_KDE_BINS, 1000);
        KDE kde = new BinnedKDE(conf);
